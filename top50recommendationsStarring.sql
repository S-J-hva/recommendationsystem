...
## update the dataset with Starring as vector from lexemesStarring
...
WHERE lexemesStarring @@ to_tsquery('diesel')
...
SELECT Starring FROM movies WHERE url='2-fast-2-furious')));
...
CREATE TABLE recommendationsBasedOnStarringField AS SELECT url,
...
'/home/pi/RSL/top50recommendationsStarringcsv' WITH csv 
